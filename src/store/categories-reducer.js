...
const initialState = {
    categories: [
        ...
        { name: 'Electronics', displayName: 'Electronics', description: 'Electronics description' , url: 'https://www.1stunitedpawn.com/wp-content/uploads/2014/03/Electronics.png'},
    ],
    active: '',
}
